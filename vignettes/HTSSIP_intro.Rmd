...
```{r}
# Third argument is a filter condition - make sure the syntax is correct!
...
```{r}
physeq_S2D2_l <- phyloseq_subset(physeq_S2D2, params, ex) # here, an error is shown, but the output seems correct....  
physeq_S2D2_l
```
